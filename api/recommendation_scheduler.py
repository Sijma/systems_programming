...
from backend import mail, MAIL_USERNAME
from backend.recommendations import get_recommendation_coupon
from app import app
import json
    ...
    with app.app_context():
        for subscription in subscriptions:
            ...
            if cached_recommendations is None:
                res = get_recommendation_coupon(recommender, user_id, 5)  # TODO: Change to rec_amount MAX
